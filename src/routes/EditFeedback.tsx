              ...
              {({ isSubmitting, values }) => (
                <Form>
                  ...
                  <div className="mt-10 flex flex-col gap-4">
                    <button
                      className="bg-[#AD1FEA] w-full rounded-lg h-10 text-white font-bold"
                    ...
                    <button
                      type="button"
                      disabled={isSubmitting}
                      className="bg-[#3A4374] w-full rounded-lg h-10 text-white font-bold"
                      onClick={() => navigate(-1)}
                    >
                      Cancel
                    </button>
                    <button
                      className="bg-[#D73737] w-full rounded-lg h-10 text-white font-bold"
                      disabled={isSubmitting}
                      onClick={() => {
                        navigate("/");
