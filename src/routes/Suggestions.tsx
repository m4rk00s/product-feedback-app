...
export default function Suggestions() {
  ...
  return (
    <div className="md:p-10 md:gap-10 relative min-h-full flex flex-col bg-[#F7F8FD]">
      {/* header */}
      <div className="md:grid md:grid-cols-3 md:gap-[0.625rem] md:h-48 md:static z-20 sticky top-0">
        {/* title */}
        ...
        {/* filter */}
        <div className="md:flex hidden bg-white rounded-md p-6  flex-wrap gap-x-2 gap-y-4">
          <div
            className={
          ...
          {feedbacks.categories.map((c) => {
            return (
              ...
              >
                {c === "ui" || c === "ux" ? c.toUpperCase() : uppercaseWords(c)}
              </div>
            );
          })}
        </div>
                  ...
                  >
                    <div
                      className={
                        ...
                        (stat.status === "in-progress" ? "bg-[#AD1FEA]" : "") +
      ...
      <div className="relative flex flex-col flex-1">
        ...
        {/* feedbacks */}
        <div className="md:px-0 px-6 py-8 flex flex-col gap-4 flex-1">
          {/* feedback card */}
